...
CHAIN IF ~Global("A7BanterHaerDalis", "GLOBAL", 1)~ THEN HAERDAJ HaerDalis.0
  ~(TODO: HaerDalis inquires from Afaaq what he thinks of the prime material plane, as he has seen much more of it by now...)~ DO ~IncrementGlobal("A7BanterHaerDalis", "GLOBAL", 1)~
...
// Banter #2
// CHAIN IF ~Name("HaerDalis", LastTalkedToBy) Global("InToB", "GLOBAL", 0) Global("BanterActive", "LOCALS", 1) Global("A7BanterHaerDalis", "GLOBAL", 3)~ THEN A7AFAAQ HaerDalis.1
  // ~(TODO: Afaaq inquires whether HaerDalis has visited his home plane, the Elemental Plane of Air, as he has seen many different planes already...)~ DO ~IncrementGlobal("A7BanterHaerDalis", "GLOBAL", 1)~
...
// CHAIN IF ~Name("HaerDalis", LastTalkedToBy) Global("InToB", "GLOBAL", 1) Global("BanterActive", "LOCALS", 1) Global("A7BanterHaerDalis", "GLOBAL", 3)~ THEN A7AFAAQ HaerDalis.1
  // ~(TODO: Afaaq inquires whether HaerDalis has visited his home plane, the Elemental Plane of Air, as he has seen many different planes already...)~ DO ~IncrementGlobal("A7BanterHaerDalis", "GLOBAL", 1)~
...
// CHAIN IF ~Global("A7BanterHaerDalis", "GLOBAL", 5)~ THEN HAERDAJ HaerDalis.2
  // ~(TODO: HaerDalis cites a poem...)~ DO ~IncrementGlobal("A7BanterHaerDalis", "GLOBAL", 1)~
...
// Banter #4
// CHAIN IF ~Name("HaerDalis", LastTalkedToBy) Global("InToB", "GLOBAL", 0) Global("BanterActive", "LOCALS", 1) Global("A7BanterHaerDalis", "GLOBAL", 7)~ THEN A7AFAAQ HaerDalis.3
  // ~(TODO: Afaaq cites a poem which was popular at the court of a certain caliph he served some time ago...)~ DO ~IncrementGlobal("A7BanterHaerDalis", "GLOBAL", 1)~
...
// CHAIN IF ~Name("HaerDalis", LastTalkedToBy) Global("InToB", "GLOBAL", 1) Global("BanterActive", "LOCALS", 1) Global("A7BanterHaerDalis", "GLOBAL", 7)~ THEN A7AFAAQ HaerDalis.3
  // ~(TODO: Afaaq cites a poem which was popular at the court of a certain caliph he served some time ago...)~ DO ~IncrementGlobal("A7BanterHaerDalis", "GLOBAL", 1)~
...
// CHAIN IF ~Name("HaerDalis", LastTalkedToBy) Global("InToB", "GLOBAL", 1) Global("A7AfaaqEnslaved", "GLOBAL", 0) Global("A7AfaaqUpgraded", "GLOBAL", 1) Global("BanterActive", "LOCALS", 1) Global("A7BanterHaerDalis", "GLOBAL", 9)~ THEN A7AFAAQ HaerDalis.4
  // ~(TODO: Afaaq: wants to know more about Sigil...)~ DO ~IncrementGlobal("A7BanterHaerDalis", "GLOBAL", 1)~
